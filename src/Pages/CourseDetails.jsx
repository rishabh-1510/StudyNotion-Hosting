...
useEffect(() => {
    // Check if the data exists before calling GetAvgRating
    if (courseData?.data?.courseDetails?.ratingReviews) {
        const count = GetAvgRating(courseData.data.courseDetails.ratingReviews);
